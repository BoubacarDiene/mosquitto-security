...
/*!
 * \file publisher.c
 * \brief Publisher code to test "client id prefix" security mechanism
...
int main(int argc, char **argv)
{
     ...
     */
    const char *clientId = (argc == 2 ? argv[1] : "secure-publisher-id");
    ...
    char payload[] = "Testing \"client id prefix\" security mechanism";
