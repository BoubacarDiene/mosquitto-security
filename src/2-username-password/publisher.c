...
/*!
 * \file publisher.c
 * \brief Publisher code to test "username-password" security mechanism
...
int main(int argc, char **argv)
{
     ...
     */
    const char *password = (argc == 2 ? argv[1] : "secure-publisher-password");
    Logd("Authenticate client using password: %s", password);
    mosquitto_username_pw_set(mosq, "secure-publisher-username", password);
    ...
    char payload[] = "Testing \"username-password\" security mechanism";
